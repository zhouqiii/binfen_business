    ...
    <el-container >
      <el-main>
        ...
        >
          ...
          <el-row type="flex" justify="start" align="middle">
            <el-col :span="15">
              <el-form-item label="项目名称:" prop="projectName" label-width="180px">
          ...
          <el-row type="flex" justify="start" align="middle">
            <el-col :span="15">
              <el-form-item label="工作量:" prop="workload" label-width="180px">
                <el-input v-model="ruleForm.workload" disabled placeholder=""></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="15">
              <el-form-item label="立项年度:" prop="approvalData" label-width="180px">
          ...
          <el-row type="flex" justify="start" align="middle">
            <el-col :span="15">
              <el-form-item label="业务部门:" prop="businessDepartment" label-width="180px">
                <el-input v-model="ruleForm.businessDepartment" placeholder="请输入业务部门"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="15">
              <el-form-item label="科技部门:" prop="technologyDepartment" label-width="180px">
          ...
          <el-row type="flex" justify="start" align="middle">
            <el-col :span="15">
              <el-form-item label="牵头项目经理:" prop="leadManagerName" label-width="180px">
                <el-input v-model="ruleForm.leadManagerName" placeholder="请输入科技部门"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="15">
              <el-form-item label="牵头项目经理电话:" prop="leadManagerTel" label-width="180px">
          ...
          <el-row type="flex" justify="start" align="middle">
            <el-col :span="15">
              <el-form-item label="立项项目经理:" prop="approvalManagerName" label-width="180px">
                <el-input v-model="ruleForm.approvalManagerName" placeholder="请输入科技部门"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="15">
              <el-form-item label="立项项目经理电话:" prop="approvalManagerTel" label-width="180px">
...
<!--start-->
          <div >
            ...
            <el-table
              ...
              <el-table-column type="index" width="50" style="background-color: #1e6abc;margin-top: 150px" label="序号">
              </el-table-column>
              <el-table-column prop="refineName" label="细化名称" style="text-align:center">
                <template slot-scope="scope">
                  <el-form-item style="margin-bottom: 15px" :prop="'refineList.' + scope.$index + '.refineName'" >
              ...
              <el-table-column prop="workload" label="细化工作量">
                <template slot-scope="scope">
                  <el-form-item style="margin-bottom: 15px" :prop="'refineList.' + scope.$index + '.workload'" >
              ...
              <el-table-column prop = "finishProportion" label="完成比例（%）"  >
                <template slot-scope="scope">
                  <el-form-item style="margin-bottom: 15px"  :prop="'refineList.' + scope.$index + '.finishProportion'" :rules='rules.finishProportion'>
                    <el-input v-model="scope.row.finishProportion" placeholder=""></el-input>
                  </el-form-item>
                </template>
              </el-table-column>
              ...
              <el-table-column prop="state" label="商务状态">
                <template slot-scope="scope">
                  <el-form-item style="margin-bottom: 15px" :prop="'refineList.' + scope.$index + '.state'" >
              ...
              <el-table-column prop="message" label="备注">
                <template slot-scope="scope">
                  <el-form-item style="margin-bottom: 15px" :prop="'refineList.' + scope.$index + '.message'" >
...
<script>
  import { createProject,getRefineTypeList } from "@/api/businessProject";
  ...
  export default {
    ...
    data() {
      ...
      //校验是否为数字
      const checkFinishProportion = (rule, value, callback) => {
        const age = /^[0-9]*$/
        if (!age.test(value) || value > 100) {
      ...
      return {
        ...
        rules: {
          ...
          finishProportion:[
            ...
            {validator:checkFinishProportion,trigger: "blur"}
          ],
        },
        // options: []
      };
    ...
    methods: {
      ...
      check(param){
        ...
        const age = /^[0-9]*$/
        if (!age.test(param)) {
          this.$message.error('完成比例请输入不大于100的数字');
        }
        if(param > 100){
          this.$message.error('完成比例请输入不大于100的数字');
        }
