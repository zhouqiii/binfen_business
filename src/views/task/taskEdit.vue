    ...
    <el-container >
      <el-main>
          ...
          <el-row>
            <el-col :span="12">
              ...
              <el-form-item label="项目名称:" prop="projectId">
                <el-select v-model="ruleForm.projectId" disabled filterable placeholder="请选择或直接输入项目名称" @change="getRefineList()">
                  <el-option
            ...
            <el-col :span="12">
              <el-form-item label="细化名称:" prop="refineName">
                <el-select v-model="ruleForm.refineId" disabled filterable placeholder="请选择或直接输入细化名称" @change="getProgrammeList()">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="任务完成状态:" prop="taskState">
                <el-radio  v-model="ruleForm.taskState" label="1" @change="detailShow = false,ruleForm.detail = ''">已投产</el-radio>
                <el-radio  v-model="ruleForm.taskState" label="2" @change="detailShow = true">已剥离</el-radio>
              </el-form-item>

            </el-col>
          </el-row>
          <el-row type="flex" justify="start" v-if="detailShow" align="middle">
            <el-col :span="12">
              <el-form-item label="原因:" prop="detail">
                <el-input :rows="5" type="textarea" v-model="ruleForm.detail" placeholder="" ></el-input>
              </el-form-item>
        ...
        <div v-show="this.dialogVisible1" >
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="排期内容:" prop="scheduleMsg" >
          ...
          <el-form-item label="改造点状态:" prop="state">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="改造点:" prop="transformationPoint">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="风险点:" prop="dangerPoint" >
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="风险级别:" prop="dangerType">
                  <el-radio v-model="ruleForm.dangerType" label="3" >高风险</el-radio>
                  <el-radio v-model="ruleForm.dangerType" label="2" >中风险</el-radio>
                  <el-radio v-model="ruleForm.dangerType" label="1" >低风险</el-radio>
                  <el-radio v-model="ruleForm.dangerType" label="0" >无风险</el-radio>
              </el-form-item>
            </el-col>
          </el-row>
          </div>
...
<script>
  ...
  import { listByRefineId,listByRefineIdObj } from "@/api/businessProgramme";
  import { updateTask,getTaskTypeList, batchList } from "@/api/businessTask";
