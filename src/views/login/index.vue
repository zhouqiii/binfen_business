  ...
  <div>
    <el-card class="login-form-layout">
      <el-form
        ...
        label-position="left"
      >
        <h2 class="login-title color-main">交付二部内部管理系统</h2>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        loginRules: {
          username: [
            { required: true, trigger: "blur", validator: validateUsername, message: "用户名为纯英文或纯数字或两者结合，长度在2-20位字符之间" },
          ...
          if (valid) {
            ...
            this.$store
              ...
              .then(() => {
                ...
                // setCookie("username", "admin", 15);
                // setCookie("password", "macro123", 15);
